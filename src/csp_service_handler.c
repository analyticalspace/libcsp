...
void csp_service_handler(csp_conn_t * conn, csp_packet_t * packet)
{
    ...
    case CSP_PING:
        {
            ...
            // csp_log_info("SERVICE: Ping received of size %u", packet->length);
            (void) 0;
        }
        break;
    case CSP_PS:
    ...
    case CSP_REBOOT:
        ...
        return; // not a break since reboot/shutdown should never reach here
    ...
    case CSP_UPTIME:
        {
            uint32_t time = csp_get_uptime(); //csp_get_s();
